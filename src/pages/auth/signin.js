...
export default function SignIn() {
  ...
  const handleLogin = async () => {
    window.location.href =
      "https://api.instagram.com/oauth/authorize?client_id=1175082610605703&redirect_uri=https://instagram-analytics-app-r9ld.vercel.app/&scope=user_profile,user_media&response_type=code";
    // try {
