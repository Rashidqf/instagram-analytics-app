...
export default function App({ Component, pageProps }) {
  ...
  <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
    ...
    <div class="hidden lg:flex lg:gap-x-12">
      ...
      <a href="/user" class="text-sm font-semibold leading-6 text-gray-900">User Page</a>
      <a href="/checkout" class="text-sm font-semibold leading-6 text-gray-900">Subscritpion</a>
    </div>
    <div class="hidden lg:flex lg:flex-1 lg:justify-end">
      <a href="/auth/signin" class="text-sm font-semibold leading-6 text-gray-900">Log in <span aria-hidden="true">&rarr;</span></a>
      <a href="/auth/signup" class="text-sm font-semibold leading-6 text-gray-900">Sign up <span aria-hidden="true">&rarr;</span></a>
    </div>
